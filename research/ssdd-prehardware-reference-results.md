...
The harness and generated result files are retained outside the public web build:

```text
/home/ubuntu/gem5-ssdd/ssdd_validation/prehardware_reference.py
/home/ubuntu/gem5-ssdd/ssdd_validation/prehardware_ledger_reference.rs
/home/ubuntu/gem5-ssdd/ssdd_validation/run_prehardware_extended.sh
/home/ubuntu/gem5-ssdd/ssdd_validation/results/prehardware/
```

The evidence matrix and source catalog explain how the supplied SSDD documents were translated into test cases:

```text
research/prehardware-verification-matrix.md
research/prehardware-source-catalog.md
```
